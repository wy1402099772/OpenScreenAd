...
@interface OpenScreenAdSkipButtonTwo ()
...
@implementation OpenScreenAdSkipButtonTwo
...
- (UILabel *)actionButton {
    if(!_actionButton) {
        ...
        _actionButton.backgroundColor = OSA_UIColorFromRGBA(231, 53, 82, 0.4);
