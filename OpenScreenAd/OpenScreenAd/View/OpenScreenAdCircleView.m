...
@interface OpenScreenAdCircleView () <UIGestureRecognizerDelegate>
{
...
@implementation OpenScreenAdCircleView
...
- (id) initWithFrame:(CGRect)frame{
    ...
    if(self){
        ...
        self.arcThickness = kOSASkipCircleWidth;
...
//        [self addSubview:self.iconImage];
        ...
        _trackLayer.opacity = 0; //背景圆环的背景透明度
        ...
        _startCircle.backgroundColor = [UIColor colorWithRed:0/255.f green:0xaa/255.f blue:0xee/255.f alpha:1.0f];
