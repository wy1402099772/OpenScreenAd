...
-(CAGradientLayer *)flashLayer {
    if (!_flashLayer) {
        ...
        keyAnima_group2.values= @[[NSValue valueWithCGPoint:CGPointMake(0, btnHeight/2.f)], [NSValue valueWithCGPoint:CGPointMake(btnWidth*0.6f, btnHeight/2.f)], [NSValue valueWithCGPoint:CGPointMake(btnWidth, btnHeight/2.f)]];
